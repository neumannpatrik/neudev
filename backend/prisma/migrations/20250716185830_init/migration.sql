-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CONSULTATION', 'TASK');

-- CreateEnum
CREATE TYPE "ActivityStatus" AS ENUM ('NEW', 'UNDER_DEVELOPMENT', 'DONE_UNPAID', 'DONE_PAID');
...
CREATE TABLE "activities" (
    ...
    "hourRate" DOUBLE PRECISION NOT NULL DEFAULT 8000,
